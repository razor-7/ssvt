...
Build a 20-page (42+ HTML files when dynamic routes are expanded) static corporate website
...
**Scale/Scope**: 20 page types → ~42 pre-rendered HTML files; 20+ JSON data files; 9 services; 10 industries; 4+ case studies
...
│   ├── partners.json
│   ├── awards.json
│   ├── tracking.json               # shipment tracking page content + SEO
│   └── privacy-policy.md
│
...
│   ├── favicon.svg                 # branded SVG favicon (gradient orange + white chart icon)
│   ├── favicon.ico                 # multi-size ICO (16/32/48px) generated by scripts/generate-favicon.mjs
│   ├── site.webmanifest            # PWA manifest (name, theme colour, icon references)
...
│   │   └── sections/
│   │       ├── HeroSection.jsx
│   │       ├── TrustBanner.jsx     # 6-tile certification strip (ISO, OHSAS, IC T50, global offices, 24/7)
│   │       ├── ServicesSection.jsx
...
│   │   ├── careers/main.jsx
│   │   ├── contact/main.jsx
│   │   ├── tracking/main.jsx       # island entry — hydrates TrackingForm, SearchBar, BackToTop
...
│   │   ├── CareersPage.jsx
│   │   ├── ContactPage.jsx
│   │   ├── TrackingPage.jsx        # shipment tracking page (form card + how-it-works + help)
...
│   └── generate-favicon.mjs        # Node.js: rasterises favicon.svg → favicon.ico (16/32/48px) + site.webmanifest
│
